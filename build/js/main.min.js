  ...
  _createClass(CalendarLayout, [{
    ...
    value: function addSidebar() {
      ...
      var _loop = function _loop() {
        ...
        var n = i - (5 - _this.calendar.selected.month);
        ...
        monthElement.addEventListener('click', function () {
          _this.changeCalendar(_this.calendar, _this.element, adj);
        });
        monthElement.innerHTML = _this.calendar.monthsLocale[n].substring(0, 3);
      ...
      for (var i = 0; i < this.calendar.monthsLocale.length - 1; i++) {
        _loop();
      }
    ...
    value: function addHeader() {
      ...
      if (this.calendar.options.showHeaderMonth) {
        var monthLabelElement = this._createElement({
          tagName: 'span',
          className: 'ecalendr__month'
        });
      ...
      if (this.calendar.options.showHeaderYear) {
        var yearLabelElement = this._createElement({
          tagName: 'span',
    ...
    value: function addDays() {
      var _this2 = this;
      var daysListElement = this._createElement({
        tagName: 'ul',
...
var ECalendr = /*#__PURE__*/_createClass(function ECalendr(element) {
...
var initEventCalendar = function initEventCalendar() {
  var calendarElement = document.querySelector('.ecalendr');
  if (!calendarElement) {
    return;
  }
