...
var Calendar = /*#__PURE__*/function () {
  function Calendar(_ref) {
    ...
    this.options = Object.assign({
      ...
      eventItemTemplate: function eventItemTemplate(jsonContent) {
...
var CalendarLayout = /*#__PURE__*/function () {
  ...
  _createClass(CalendarLayout, [{
      ...
      if (activeSidebarElement && !isYearChange) {
        ...
        if (this.isChangeLocale) {
          this.currentMonths.forEach(function (month, i) {
            ...
            month.label = _this.calendar.monthsLocale[i];
    ...
    value: function getEvents(url) {
      ...
      fetch(url).then(function (res) {
        if (!res.ok) {
          ...
          _this3.changeCalendar(_this3.calendar, 0);
    ...
    key: "_goDate",
    value: function _goDate(month, year) {
      var currMonth = this.calendar.selected.month;
      var currYear = this.calendar.selected.year;
    ...
    key: "_setLocale",
    value: function _setLocale(code) {
