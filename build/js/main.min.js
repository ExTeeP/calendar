...
/* harmony import */ var _modules_calendar_init_ecalendr_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/calendar/init-ecalendr.js */ "./js/modules/calendar/init-ecalendr.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    Object(_modules_calendar_init_ecalendr_js__WEBPACK_IMPORTED_MODULE_4__["initEventCalendar"])();
  });
});
...
/***/ "./js/modules/calendar/ecalendr.js":
/*!*****************************************!*\
  !*** ./js/modules/calendar/ecalendr.js ***!
  \*****************************************/
/*! exports provided: ECalendr */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ECalendr", function() { return ECalendr; });
...
var Calendar = /*#__PURE__*/function () {
  function Calendar(_ref) {
    ...
    this.options = Object.assign({
      ...
      eventItemTemplate: function eventItemTemplate() {}
    }, options);
...
var CalendarLayout = /*#__PURE__*/function () {
  function CalendarLayout(_ref2) {
    var calendar = _ref2.calendar,
      element = _ref2.element,
      adjuster = _ref2.adjuster;
  ...
  _createClass(CalendarLayout, [{
    ...
    value: function addSidebar(isYearChange) {
      var _this = this;
      var activeSidebarElement = this.element.querySelector('.ecalendr__sidebar');
      if (activeSidebarElement && !isYearChange) {
        // переключение месяца
        var prevSelectedMonth = activeSidebarElement.querySelector('.ecalendr__month--selected');
        var newSelectedMonth = activeSidebarElement.querySelector("[data-idx='".concat(this.calendar.selected.month, "']"));
        ...
        this.calendar.monthsLocale.forEach(function (label, i) {
          var monthElement = activeSidebarElement.querySelector("[data-idx='".concat(i, "']"));
          var eventMonths = document.querySelectorAll('.ecalendr__month--event');
          eventMonths.forEach(function (el) {
            el.removeAttribute('title');
            el.classList.remove('ecalendr__month--event');
          });
          _this.currentMonths.push({
      ...
      var sidebarElement = this._createElement({
        className: 'ecalendr__sidebar'
      });
      var monthListElement = this._createElement({
        tagName: 'ul',
        className: 'ecalendr__months'
      });
      this.calendar.monthsLocale.forEach(function (label, i) {
        var monthElement = _this._createElement({
          tagName: 'li',
          className: 'ecalendr__month'
        });
        ...
        if (_this.calendar.options.sidebar.shortMonthLabel) {
          monthElement.innerText = "".concat(label.substring(0, 3));
        } else {
          monthElement.innerText = "".concat(label);
        }
        if (i === _this.calendar.today.getMonth() && _this.calendar.selected.year === _this.calendar.today.year) {
          monthElement.classList.add('ecalendr__month--current');
        }
        ...
        _this._renderElement(monthListElement, monthElement);
      });
    ...
    value: function addNavigation() {
      var headerElement = this._createElement({
        className: 'ecalendr__header'
      });
    ...
    value: function addHeader() {
      var headerElement = this.element.querySelector('.ecalendr__header');
      var monthLabelElement = this.element.querySelector('.ecalendr__month');
      var yearLabelElement = this.element.querySelector('.ecalendr__year');
      if (headerElement) {
      ...
      headerElement = this._createElement({
        className: 'ecalendr__header'
      });
      var monthElement = this._createElement({
        className: 'ecalendr__current-month'
      });
      if (this.calendar.options.header.showMonth) {
        monthLabelElement = this._createElement({
          tagName: 'span',
          className: 'ecalendr__month'
        });
        monthLabelElement.innerText = this.calendar.monthsLocale[this.calendar.selected.month];
      ...
      if (this.calendar.options.header.showYear) {
        yearLabelElement = this._createElement({
          tagName: 'span',
          className: 'ecalendr__year'
        });
        yearLabelElement.innerText = this.calendar.selected.year;
    ...
    value: function addWeekdays() {
      var labelsListElement = this._createElement({
        tagName: 'ul',
        className: 'ecalendr__weekdays'
      });
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          var labelItemElement = this._createElement({
            tagName: 'li',
            className: 'ecalendr__weekday'
          });
    ...
    value: function addDays() {
      var _this2 = this;
      this.daysListElement = this._createElement({
        tagName: 'ul',
        className: 'ecalendr__days'
      });
      var dayItemElement;
      var dayInnerLayout;
      var addWeekendClass = function addWeekendClass(count) {
        for (var j = 0; j < _this2.calendar.weekends.length; j++) {
          if (count === _this2.calendar.weekends[j]) {
      ...
      for (var i = 0; i < this.calendar.selected.firstDay; i++) {
        dayItemElement = this._createElement({
          tagName: 'li',
          className: ['ecalendr__day', 'ecalendr__day--prev']
        });

        // Выходные дни
        var weekendCount = i % 7;
      ...
      // Дни текущего месяца
      for (var _i = 0; _i < this.calendar.selected.days; _i++) {
        dayItemElement = this._createElement({
          tagName: 'li',
          className: ['ecalendr__day', 'ecalendr__day--current']
        });

        // Выходные дни
        var _weekendCount = (_i + this.calendar.selected.firstDay) % 7;
        addWeekendClass(_weekendCount);
        dayInnerLayout = this.createDayWrap(_i + 1);
        this._renderElement(dayItemElement, dayInnerLayout);

        // Сегодняшний день
        if (_i + 1 === this.calendar.today.getDate() && this.calendar.selected.month === this.calendar.today.month && this.calendar.selected.year === this.calendar.today.year) {
      ...
      var extraDaysCount = 13;
      if (this.daysListElement.children.length > 35) {
        extraDaysCount = 6;
      } else if (this.daysListElement.children.length < 29) {
        extraDaysCount = 20;
      }
      for (var _i2 = 0; _i2 < extraDaysCount - this.calendar.selected.lastDay; _i2++) {
        dayItemElement = this._createElement({
          tagName: 'li',
          className: ['ecalendr__day', 'ecalendr__day--next']
        });

        // Выходные дни
        var _weekendCount2 = (_i2 + this.calendar.selected.lastDay + 1) % 7;
        addWeekendClass(_weekendCount2);
        dayInnerLayout = this.createDayWrap(_i2 + 1);
        this._renderElement(dayItemElement, dayInnerLayout);
        this._renderElement(this.daysListElement, dayItemElement);
      }
    ...
    key: "addDayEvents",
    value: function addDayEvents() {
      // Добавляет события для текущего месяца
      var currentDays = document.querySelectorAll('.ecalendr__day.ecalendr__day--current');
      var events;
      for (var i = 0; i < this.calendar.selected.days; i++) {
        var day = currentDays[i];
        events = day.querySelector('.ecalendr__events');

        // Check Date against Event Dates
        for (var n = 0; n < this.calendar.model.length; n++) {
          var evDate = new Date(new Date(this.calendar.model[n].datetime).getFullYear(), new Date(this.calendar.model[n].datetime).getMonth(), new Date(this.calendar.model[n].datetime).getDate());
          var toDate = new Date(this.calendar.selected.year, this.calendar.selected.month, i + 1);
          if (evDate.getTime() === toDate.getTime()) {
            var eventElement = this._createElement({
              tagName: 'span',
              className: 'ecalendr__event'
            });
            day.classList.add('ecalendr__day--event');
            day.setAttribute('tabindex', '0');
            if (this.calendar.model[n].url) {
              eventElement = this._createElement({
                tagName: 'a',
                className: 'ecalendr__event'
              });
    ...
    value: function getEventTemplate(jsonContent) {
      return this.calendar.options.eventItemTemplate(jsonContent);
    }
  }, {
    key: "addSidebarEvents",
    value: function addSidebarEvents() {
      // Добавляет информацию о событиях в боковом меню
      for (var i = 0; i < this.currentMonths.length; i++) {
        var monthObj = this.currentMonths[i];
        monthObj.eventsCount = 0;
        for (var n = 0; n < this.calendar.model.length; n++) {
          var evDate = new Date(new Date(this.calendar.model[n].datetime).getFullYear(), new Date(this.calendar.model[n].datetime).getMonth());
          var toDate = new Date(this.currentMonths[i].date);
          if (evDate.getTime() === toDate.getTime()) {
            monthObj.eventsCount++;
            monthObj.element.title = "\u041A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E \u0441\u043E\u0431\u044B\u0442\u0438\u0439 \u0432 \u044D\u0442\u043E\u043C \u043C\u0435\u0441\u044F\u0446\u0435: ".concat(monthObj.eventsCount);
    ...
    key: "addNavButtons",
    value: function addNavButtons(parent) {
      var prevElement = this._createElement({
        tagName: 'button',
        className: ['ecalendr__nav-btn', 'ecalendr__nav-btn--prev']
      });
      var nextElement = this._createElement({
        tagName: 'button',
        className: ['ecalendr__nav-btn', 'ecalendr__nav-btn--next']
      });
      ...
      if (this.calendar.options.navigation.prev.text && this.calendar.options.navigation.next.text) {
        var prevBtnTxtElement = this._createElement({
          tagName: 'span',
          className: 'ecalendr__nav-btn-text'
        });
        var nextBtnTxtElement = this._createElement({
          tagName: 'span',
          className: 'ecalendr__nav-btn-text'
        });
    ...
    key: "createDayWrap",
    value: function createDayWrap(dayLabel) {
      // Создание разметки внутри элемента дня
      var dayWrapElement = this._createElement({
        className: 'ecalendr__day-inner'
      });
      var numberElement = this._createElement({
        className: 'ecalendr__number'
      });
      var linksElement = this._createElement({
        className: 'ecalendr__events'
      });
    ...
    value: function createCalendar() {
      ...
      this.parent = this._createElement({
        className: 'ecalendr'
      });
      this.mainSection = this._createElement({
        className: 'ecalendr__main'
      });
      this.bodySection = this._createElement({
        className: 'ecalendr__body'
      });
    ...
    key: "changeCalendar",
    value: function changeCalendar(calendar, element, adjuster) {
    ...
    value: function getEvents(url) {
      ...
      fetch(url).then(function (res) {
        if (!res.ok) {
          ...
          _this3.changeCalendar(_this3.calendar, _this3.element, 0);
          throw new Error(res.status);
        }
        return res.json();
      }).then(function (data) {
        _this3.calendar.model = data.events;
        _this3.element.dispatchEvent(new CustomEvent('loadDataSuccess'));
        return data;
      });
    }
  }, {
    ...
    value: function offsetEventsTooltip(evt) {
      var eventDay = evt.target.closest('.ecalendr__day--event');
      if (!eventDay) {
        return;
      }
      var eventsElement = eventDay.querySelector('.ecalendr__events');
      ...
      if (wrapBoxCrd.width >= vw) {
        ...
        eventsElement.style.width = "".concat(vw - this.calendar.options.tooltipOffsetFromEdge * 2, "px");
        wrapBoxCrd = eventsElement.getBoundingClientRect();
        eventsElement.style.left = "".concat(vw - (wrapBoxCrd.x + wrapBoxCrd.width) - this.calendar.options.tooltipOffsetFromEdge, "px");
    ...
    value: function onSidebarMonthClick(evt) {
      ...
      var selectedMonth = evt.currentTarget.querySelector('.ecalendr__month--selected');
      if (selectedMonth) {
    ...
    value: function onEventDayClick(evt) {
      var eventDay = evt.target.closest('.ecalendr__day--event');
      var activeDay = document.querySelector('.ecalendr__day--event.is-active');
      var onMissClick = function onMissClick() {
        if (eventDay) {
          return;
        }
        var activeItems = document.querySelectorAll('.ecalendr__day.is-active');
    ...
    value: function onNavArrowsClick(evt) {
      ...
      var adjuster = target.closest('.ecalendr__nav-btn--prev') ? -1 : 1;
    ...
    value: function _createElement(props) {
      ...
      var selector = props.className;
      var element = document.createElement(tag);
      if (selector) {
        if (Array.isArray(selector)) {
          var _element$classList;
          (_element$classList = element.classList).add.apply(_element$classList, _toConsumableArray(selector));
        } else {
    ...
    key: "_renderElement",
    value: function _renderElement(container, component) {
...
var ECalendr = /*#__PURE__*/function () {
  function ECalendr(element) {
    var settings = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    _classCallCheck(this, ECalendr);
...
/***/ "./js/modules/calendar/init-ecalendr.js":
/*!**********************************************!*\
  !*** ./js/modules/calendar/init-ecalendr.js ***!
  \**********************************************/
...
/* harmony import */ var _ecalendr_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ecalendr.js */ "./js/modules/calendar/ecalendr.js");

var initEventCalendar = function initEventCalendar() {
  var calendarElement = document.querySelector('[data-ecalendr]');
  if (!calendarElement) {
    return;
  }
  var getEventItemTemplate = function getEventItemTemplate(obj) {
    var fragment = new DocumentFragment();
    var title = obj.title,
      body = obj.body;
    var titleElement = document.createElement('span');
    titleElement.textContent = title;
    var bodyElement = document.createTextNode(body);
    fragment.append(titleElement);
    fragment.append(bodyElement);
    return fragment;
  };
  var calendar = new _ecalendr_js__WEBPACK_IMPORTED_MODULE_0__["ECalendr"](calendarElement, {
